...
export default function Community() {
    ...
    return (
        <div className="p-0 pb-24 h-full flex flex-col bg-stone-50">
            {/* Header */}
            <div className="bg-white p-6 sticky top-0 z-10 shadow-sm border-b border-stone-100">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 shadow-lg shadow-primary-900/20 transition-all"
                >
                    <Plus className="w-5 h-5" />
                    Share Your Crop Status
                </motion.button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
                {posts.map((post, index) => (
                    ...
                    >
                        ...
                        <p className="px-4 pt-3 text-stone-700 text-sm leading-relaxed whitespace-pre-wrap">
                            {post.content}
                        </p>
                        ...
                        <div className="flex items-center justify-between px-4 py-3 border-t border-stone-100 text-stone-500">
                            ...
                            <button className="flex items-center gap-1.5 text-sm hover:text-primary-600 transition-colors">
                        ...
                        <form onSubmit={handlePost} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    className="border-2 border-dashed border-stone-300 rounded-2xl p-8 text-center cursor-pointer hover:border-primary-500 hover:bg-primary-50 transition-all"
                                >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full bg-white border border-stone-200 rounded-xl px-4 py-3 text-stone-700 outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all"
                                    required
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g., Leaf Blight, Healthy, Brown Spot"
                                    className="w-full bg-white border border-stone-200 rounded-xl px-4 py-3 text-stone-700 outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Share details, symptoms, treatments, or tips..."
                                    rows="4"
                                    className="w-full bg-white border border-stone-200 rounded-xl px-4 py-3 text-stone-700 outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all resize-none"
                                    required
                                />
                            </div>
